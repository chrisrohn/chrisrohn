...
const ART_MAX = 400;
const SHELL = ["/", "/index.html", "__APP_JS__", "/style.css", "/theme.js", "/manifest.webmanifest", "/data/feed.json", "/data/catalog.json", "/data/concerts.json", "/data/duplicates.json", "/data/unavailable.json", "/data/videos.json",
